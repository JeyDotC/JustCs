...
namespace JeyDotC.JustCs.Html.Attributes
{
    ...
    /// HTML attributes.
    /// </summary>
    public class Attrs : IElementAttributes
    {
...
#pragma warning restore CS0618 // Type or member is obsolete
                    ...
                    Oncopy == other.Oncopy &&
                    Oncut == other.Oncut &&
                    Ondblclick == other.Ondblclick &&
                    Ondrag == other.Ondrag &&
                    Ondragend == other.Ondragend &&
                    Ondragenter == other.Ondragenter &&
                    Ondragleave == other.Ondragleave &&
                    Ondragover == other.Ondragover &&
                    ...
                    Onmousewheel == other.Onmousewheel &&
                    Onpaste == other.Onpaste &&
                    Onscroll == other.Onscroll &&
                    Onselect == other.Onselect &&
                    Onwheel == other.Onwheel &&
                    Muted == other.Muted &&
                    Poster == other.Poster &&
                    Label == other.Label &&
                    Default == other.Default &&
                    Kind == other.Kind &&
                    Oncuechange == other.Oncuechange &&
                    ...
                    Value == other.Value &&
                    Formaction == other.Formaction &&
                    Disabled == other.Disabled &&
                    Form == other.Form &&
                    Name == other.Name &&
                    Onload == other.Onload &&
                    Onafterprint == other.Onafterprint &&
                    Onbeforeprint == other.Onbeforeprint &&
                    Onbeforeunload == other.Onbeforeunload &&
                    Onhashchange == other.Onhashchange &&
                    Onoffline == other.Onoffline &&
                    Ononline == other.Ononline &&
                    Onpagehide == other.Onpagehide &&
                    Onpageshow == other.Onpageshow &&
                    Onpopstate == other.Onpopstate &&
                    ...
                    Loop == other.Loop &&
                    Oncanplaythrough == other.Oncanplaythrough &&
                    Ondurationchange == other.Ondurationchange &&
                    Onemptied == other.Onemptied &&
                    Onended == other.Onended &&
                    Onloadeddata == other.Onloadeddata &&
                    Onloadedmetadata == other.Onloadedmetadata &&
                    Onloadstart == other.Onloadstart &&
                    Onpause == other.Onpause &&
                    Onplay == other.Onplay &&
                    Onplaying == other.Onplaying &&
                    Onprogress == other.Onprogress &&
                    Onratechange == other.Onratechange &&
                    Onseeked == other.Onseeked &&
                    Onseeking == other.Onseeking &&
                    Onstalled == other.Onstalled &&
                    Onsuspend == other.Onsuspend &&
                    Ontimeupdate == other.Ontimeupdate &&
                    Onvolumechange == other.Onvolumechange &&
                    Onwaiting == other.Onwaiting &&
                    Preload == other.Preload &&
                    Oncanplay == other.Oncanplay &&
